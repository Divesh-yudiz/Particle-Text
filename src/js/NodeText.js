...
import nodeTextVs from '../shaders/nodeText.vs';
import nodeTextFs from '../shaders/nodeText.fs';
import nodeTextWirefs from '../shaders/nodeTextWire.fs';
import nodeTextPointsVs from '../shaders/nodeTextPoints.vs';
import nodeTextPointsFs from '../shaders/nodeTextPoints.fs';
...
export default class Node {
  ...
  createObj(font) {
    ...
    const baseGeometries = [
      new TextGeometry('YUDIZ', optTextGeometry),
      new TextGeometry('DIVESH', optTextGeometry)
    ];
    ...
    const material = new THREE.RawShaderMaterial({
      ...
      vertexShader: nodeTextVs,
      fragmentShader: nodeTextFs,
      depthWrite: false,
      transparent: true,
    });
    ...
    const materialPoints = new THREE.RawShaderMaterial({
      uniforms: this.uniforms,
      vertexShader: nodeTextPointsVs,
      fragmentShader: nodeTextPointsFs,
      depthWrite: false,
      transparent: true,
    });
